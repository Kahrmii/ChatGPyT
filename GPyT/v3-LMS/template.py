...
def chat_loop():
    ...
    """
    # Explicitly type messages to satisfy type checkers (pyright/mypy)
        ...
        try:
            ...
            if response.choices[0].message.tool_calls:
                ...
                messages.append(
                    {
                        "role": "assistant",
                        # content can be empty when the assistant is issuing tool calls
                        "content": "",
                        "tool_calls": [
                            {
                                "id": tool_call.id,
                                "type": tool_call.type,
                                # Reconstruct function param explicitly to match SDK types
                                "function": {
